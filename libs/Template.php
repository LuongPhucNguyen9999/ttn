...
class Template
{
	...
	public function load()
	{
		...
		if (file_exists($pathFileConfig)) {
			...
			$view->_cssFiles = isset($arrConfig['dirCss']) ? $view->createLink($this->_folderTemplate . $arrConfig['dirCss'], $arrConfig['fileCss'], 'css') : '';
			$view->_jsFiles = isset($arrConfig['dirJs']) ? $view->createLink($this->_folderTemplate . $arrConfig['dirJs'], $arrConfig['fileJs'], 'js') : '';
