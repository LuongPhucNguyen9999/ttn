...
$lblName    = Helper::cmsLinkSort('Hoc Ky - Nam Hoc', 'username', $columnPost, $orderPost);
...
$paginationHTML = $this->pagination->showPagination(URL::createLink('admin', 'hocky', 'index'));
				...
				<tbody>
					...
					if (!empty($this->Items)) {
						...
						foreach ($this->Items as $key => $value) {
							...
							$linkEdit = URL::createLink('admin', 'hocky', 'form', array('id' => $id));
