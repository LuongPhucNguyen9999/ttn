...
$selectStatus = Helper::cmsSelectbox('form[status]', null, array('default' => '--Select status--', 1 => 'Publish', 0 => 'Unpublish'), $this->arrParam['form']['status'], 'width:115px');
$selectGroupACP = Helper::cmsSelectbox('form[group_acp]', null, array('default' => '--Select group acp--', 1 => 'Yes', 0 => 'No'), $this->arrParam['form']['group_acp'], 'width:115px');
