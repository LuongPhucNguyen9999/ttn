...
{
	private $_columns = array('id', 'username', 'created', 'created_by', 'modified', 'modified_by');

	public function __construct()
	{
		parent::__construct();
		$this->setTable(TBL_HK);
	}
	...
	{
		$query[] = "Select `id`, `username`, `created`, `created_by`, `modified`, `modified_by`";
		$query[] = "From `$this->table`";
		$query[] = "Where `id` > 0";
